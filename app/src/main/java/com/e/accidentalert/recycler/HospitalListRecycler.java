package com.e.accidentalert.recycler;
...
import com.e.accidentalert.activities.DetailActivity;
    ...
    public void onBindViewHolder(@NonNull ListHolder holder, int position) {
        ...
        String address = currentItem.getVicinity();
         if (address != null) {
             ...
             Toast.makeText(ctx, "Address Not Available", Toast.LENGTH_SHORT).show();
         }
